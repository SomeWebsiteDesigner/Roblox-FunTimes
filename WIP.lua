...
function dprint(str)
	if _G.fishdebug then
		game:GetService('TestService'):Message("[Fish Sim REVAMPED] "..str)
	end
end

--Load GUI
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/SomeWebsiteDesigner/Roblox-FunTimes/main/Library.lua?token=GHSAT0AAAAAABUIZEMHUVMOYHTMTC5XOCGUYUTD7QQ", true))()
dprint("GUI Library Loaded")
local fishGui = library:CreateWindow('Fish Sim ' .. currVersion)
fishGui:Section('By Nymphoria @ V3rm')
fishGui:Section('Revamped By SomeCoder @ V3rm')
dprint("GUI Window Created")
local mainGui = library:CreateWindow('Main')
mainGui:Section('By Nymphoria @ V3rm')
mainGui:Section('Revamped By SomeCoder @ V3rm')
dprint("Main Window Created")
local teleGui = library:CreateWindow('Teleport')
teleGui:Section('By Nymphoria @ V3rm')
teleGui:Section('Revamped By SomeCoder @ V3rm')
